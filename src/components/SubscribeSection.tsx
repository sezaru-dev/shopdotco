...
const SubscribeSection = () => {
  return (
    <div className='absolute bottom-[1.2rem] lg:bottom-[3.4rem] w-full'>
      <div className='bg-black rounded-lg px-6 lg:px-16 py-[28px] lg:py-[36px] flex flex-col lg:flex-row items-center justify-between'>
        <h2 className='lg:w-[551px] font-bold text-[32px] lg:text-[2.5rem] text-white leading-none lg:leading-[45px]'>STAY UPTO DATE ABOUT OUR <br className='md:hidden'/>LATEST OFFERS</h2>

...
const Counter = ({width}:CounterType) => {
  ...
  return (
    <div className={`w-[${width}] py-3 px-4 lg:py-4 lg:px-5 relative inline-flex items-center gap-4 bg-[#F0F0F0] rounded-full font-satoshi text-sm font-medium overflow-hidden`}>
